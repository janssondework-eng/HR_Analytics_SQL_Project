...
- Для Junior Data Analyst наиболее востребованы hard skills: **SQL (209 упоминаний)**, **Python (117)**, **анализ данных (92)**, **Power BI (52)** и **Pandas (51)**.
- Для Middle Data Analyst сохраняется похожий стек: **SQL (100)**, **Python (78)**, **анализ данных (46)**, **Pandas (34)** и **Power BI (21)**.
...
### 1. SQL — ключевой навык для входа в аналитику

SQL чаще всего встречается в требованиях к Junior Data Analyst, поэтому кандидату важно уверенно владеть:
...
### 2. Python и Pandas повышают конкурентоспособность

Python является вторым по востребованности hard skill для Data Analyst. Даже базовое владение Python для анализа данных заметно усиливает профиль кандидата.

### 3. Power BI стоит добавить в портфолио

BI-инструменты регулярно встречаются среди требований работодателей. Хорошим дополнением станет собственный dashboard-проект по анализу продаж, клиентов или финансовых показателей.

### 4. Москва и Санкт-Петербург остаются основными центрами найма

На эти регионы приходится большая часть вакансий аналитиков, что делает их наиболее перспективными для поиска работы и карьерного роста.

### 5. Банки и крупные экосистемы являются крупнейшими работодателями
...
Для успешного трудоустройства важно развивать навыки SQL, анализа данных, подготовки отчётности и понимания бизнес-процессов.

### 6. Soft skills имеют значение

Работодатели ожидают от аналитика не только технических навыков, но и умения:

- коммуницировать с командой;
- документировать решения;
- презентовать результаты анализа;
- объяснять бизнес-выводы.

### 7. Оптимальная стратегия развития Junior Analyst

1. Усилить SQL до уверенного уровня.
2. Освоить Python и Pandas.
3. Создать Power BI Dashboard.
4. Оформить 2–3 проекта на GitHub.
5. Адаптировать резюме под банки, финтех и крупные компании.
